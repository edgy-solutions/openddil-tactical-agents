...
from source_app import make_hq_source_app, make_source_app
...
def main() -> int:
    ...
    # HQ source — routes asset-cm-state AND asset-logistics-status through
    # the fan-in topic. Both topics are produced on hq (per §A) and have 8
